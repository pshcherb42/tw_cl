...
export default function PostButtons({
  ...
  commentsCount
    ...
    return (
        <div className="flex justify-between mr-12 text-twitter-light-grey text-sm mt-1">
          ...
          <button className={(likedByMe ? 'text-red-500 fill-red-500 ' : '') + "flex items-center cursor-pointer"} onClick={toggleLike}>
...
// we create 4 divs, for each button
// we add onClick for functionality
// add likesCount to count likes
// to count likes we use state